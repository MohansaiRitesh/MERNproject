...
const EditProfile = () => {
    ...
    return (
        <>
            <div className='fixed z-50 inset-0 overflow-y-auto font-serif'>
                        ...
                        >
                            ...
                            <div className='py-5 sm:flex sm:flex-row-reverse border-t border-[#66666645]'>
                                {isSubmitting ? (
                                    ...
                                    <CustomButton
                                        type='submit'
                                            containerStyles={`inline-flex justify-center rounded-md bg-[#a829f0] px-8 py-3 text-sm font-medium text-white outline-none`}
                                        title='Submit'
                                    />
                                )}
                            </div>
